...
(() => {
  ...
  const TARGETS = [
    ...
    { id: 'openbb-delisted', url: 'Chatbot · Finance', label: 'OpenBB delisted-quote research',
      ...
      report: { a: 'Quote-only response', b: 'Source-grounded research', winner: 'B', lift: '+28.0%', metric: 'research accuracy', agents: 100000,
        ...
        findings: [['high', 'Quote-only responses frequently confuse delisting with temporary data gaps.'], ['med', 'Source citations sharply improve trust among analysts.'], ['low', 'Plain-language corporate-action explanations help low-expertise users.']] } },
